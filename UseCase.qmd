...
::: column-margin
**Link**\
[Base R Code](clustering_code.qmd)
:::
...
::: column-margin
**Links**\
[myApp on shinyapps.io](https://thearmbreaker.shinyapps.io/clustering-with-keras/)\
[myApp User Guide](TecDoc_Shiny.html){target="_blank"}
:::

For the deployment following code can be used. To start with the deployment a list of relevant files is created to avoid publishing of unnecessary files.
